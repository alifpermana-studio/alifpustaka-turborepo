import { Bug, ExternalLink, ThumbsUp, UserCheck } from 'lucide-react';
...
export const ModalMessage = ({ errorParam, closeModal }: Props) => {
  ...
  } else if (errorParam.error === 'unknown-error') {
    const handleSubmit = () => {
      closeModal();
    };
    return (
      <div className="flex flex-col items-center justify-center gap-4 p-8 text-gray-800 dark:text-gray-200">
        ...
        <div className="text-2xl font-semibold">Unknown error.</div>
        <div className="text-xl">
          <p>We encounter unknown error. Please contact our administrator for further support.</p>
        </div>
        <div className="mt-4 flex w-3/4 flex-row justify-between gap-10">
          <Link
            href="https://alifpustaka.net"
  ...
  } else if (errorParam.error === 'username-in-use') {
    const handleSubmit = () => {
      closeModal();
    };
    return (
      <div className="flex flex-col items-center justify-center gap-4 p-8 text-gray-800 dark:text-gray-200">
        ...
        <div className="text-2xl font-semibold">Username is already in use.</div>
        <div className="text-xl">
          <p>Your provided username already used by another user. Please try another username.</p>
        </div>
        <div className="mt-4 flex w-3/4 flex-row justify-between gap-10">
          <Link
            href="https://alifpustaka.net"
