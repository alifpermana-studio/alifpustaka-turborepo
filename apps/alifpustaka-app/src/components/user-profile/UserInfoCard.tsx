            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 lg:gap-7 2xl:gap-x-32">
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                  {status === 'authenticated' ? `${user.fname}` : status}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                  {status === 'authenticated' ? `${user.lname}` : status}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                  {status === 'authenticated' ? `${formatPhoneNumber(user.phone || '')}` : status}
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                    ...
                    <div className="col-span-2 text-white lg:col-span-1">
                      ...
                      <PhoneInput
                        ...
                        countries={countryPhoneCodes} // Default to Indonesia
