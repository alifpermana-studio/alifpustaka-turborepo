...
export function passwordResetText({ url, appName = 'Your App', host }: ResetProps) {
  return `Password Reset for ${appName}

You recently requested to reset your password for your account on ${host}.

Click the link below to set a new password:

${url}

This link is only valid for a limited time. If you did not request this, you can safely ignore this email.`;
}
          ...
          <tr>
            <td style="padding:24px 24px 0 24px">
              ...
              <p class="muted" style="margin:0;font:400 14px/1.6 -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;color:#4b5563">
                You recently requested to reset your password for your account on <strong>${host}</strong>.
              </p>
            </td>
          </tr>
